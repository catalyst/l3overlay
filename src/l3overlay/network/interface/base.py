...
# l3overlay/network/interface/base.py - network interface base class
#
...
from l3overlay.network.interface.exception import NotRemovedError
from l3overlay.network.interface.exception import RemovedThenModifiedError
